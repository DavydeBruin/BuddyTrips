...
$reservering_data = file_get_contents("data/reservering.json");
$reserveringen = json_decode($reservering_data, true);
        ...
        <div class="card">
            <div class="container">
                ...
                <div class="description">
                    <p>Bedankt! 🥳<br> U heeft betaald! Hieronder ziet u de reserveringsgegevens.</p>
                </div>
                <div class="group">
                    <span>Naam:</span>
